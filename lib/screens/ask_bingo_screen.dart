...
class AskBingoScreen extends ConsumerStatefulWidget {
  const AskBingoScreen({super.key});

  @override
  ConsumerState<AskBingoScreen> createState() => _AskBingoScreenState();
}

class _AskBingoScreenState extends ConsumerState<AskBingoScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final isProcessing = voiceState.feedback == VoiceAssistantState.processing || voiceState.feedback == VoiceAssistantState.executing;
